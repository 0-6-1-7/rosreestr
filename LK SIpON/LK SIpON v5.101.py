from get_info_5 import get_info_kn, get_info_addr, get_header
...
# значение таймаута
    ...
    lbl_about = Label(APP_WINDOW, text="Поиск по адресам и кадастровым номерам :: версия 5.100")
...
## основной цикл обработки
        ...
        t1 = 0 # точка отсчёта для первого таймаута
