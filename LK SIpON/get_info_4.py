...
def clear_notifications(RR):
    notifications = RR.find_elements(By.CSS_SELECTOR, "div.rros-ui-lib-error,rros-ui-lib-error-ERROR")
    for notification in notifications:
        button = notification.find_element(By.CSS_SELECTOR, "button.rros-ui-lib-button.rros-ui-lib-button--link")
