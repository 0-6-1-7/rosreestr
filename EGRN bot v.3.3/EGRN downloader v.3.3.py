...
def EGRNinit():
    ...
    while True:
        try:
            ...
            try:
                EGRN = webdriver.Chrome('chromedriver', options=chrome_options)
...
while True:
    ...
    if Status == "RequestPageOK":
        break
# https://rosreestr.gov.ru/wps/portal/cc_faq_query?problemId=1022&query=%D0%9F%D1%80%D0%BE%D0%B2%D0%B5%D1%80%D0%BA%D0%B0%20%D0%BD%D0%B5%20%D0%BF%D1%80%D0%BE%D0%B9%D0%B4%D0%B5%D0%BD%D0%B0
